              ...
              <div className='flex justify-center items-center gap-2'>
                ...
                <div style={{ position: 'relative' }}>
                  <input className='rounded-3xl py-3 px-3 outline-none text-xs w-[300px] pr-10 hidden lg:block md:block'
                    placeholder='Search for your favourte Pizz from menu.' />
                  <FaSearch className='w-5 h-5 text-yellow-500 absolute right-3 top-1/2 transfrom -translate-y-1/2 hidden lg:block md:block' />
                </div>
              </div>
